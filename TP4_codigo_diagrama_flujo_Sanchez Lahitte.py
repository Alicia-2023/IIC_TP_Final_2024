...
while CP == 00:
    ...
    print()
    print("La cantidad de piezas procesadas es: ",cantcp)
    print()
...
if validocodigo(codigo) == True:
    ...
    PrT= 0
    cantcp = cantcp + 1
    print("Número de pieza: ",CP)
    CC=int(input("Por favor ingresa el código de componente de por lo menos 2 dígitos o con 0 finaliza la carga de componentes de esta pieza: ",CP," : "))
    print ()
    while CC == 00:
        print("Ud ingresó 0, finaliza la carga de componentes de esta pieza")
        print()
        print("El precio total de componentes de esta pieza es: $ ",PrecioTotal)
        CC=int(input("Ingresa el código de la siguiente pieza de 2 digitos, con '0' finaliza el programa: "))
        print()
